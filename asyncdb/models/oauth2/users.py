...
from asyncdb.utils.crypto import pbkdf2, make_random_password, verify

if TYPE_CHECKING:  # pragma: no cover
    from asyncdb.models.oauth2 import AuthorizationCode, Client, Token
...
class User(DatabaseModel, table=True):  # type: ignore
    __tablename__ = "users"
